...
return array(
    'schema' => array(
        ...
        'user' => SearchReference::create('user')->to('User','first_name')->set('field',array('email','last_name')),
        ...
        'testdate3' => NormDate::create('testdate3'),
        'testdate4' => NormDateTime::create('testdate4'),
        'sysparam' => SysparamReference::create('sysparam')->setGroups('test1'),
