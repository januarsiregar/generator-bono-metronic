                                ...
                                <div class="mt-comments">
                                    <div class="mt-comment">
                                        <div class="mt-comment-img">
                                            <img src="<?php echo Theme::base('assets/pages/media/users/avatar1.jpg') ?>" /> </div>
                                    ...
                                    <div class="mt-comment">
                                        <div class="mt-comment-img">
                                            <img src="<?php echo Theme::base('assets/pages/media/users/avatar6.jpg') ?>" /> </div>
                                        <div class="mt-comment-body">
                                            <div class="mt-comment-info">
                                    ...
                                    <div class="mt-comment">
                                        <div class="mt-comment-img">
                                            <img src="<?php echo Theme::base('assets/pages/media/users/avatar8.jpg') ?>" /> </div>
                                        <div class="mt-comment-body">
                                            <div class="mt-comment-info">
                                    ...
                                    <div class="mt-comment">
                                        <div class="mt-comment-img">
                                            <img src="<?php echo Theme::base('assets/pages/media/users/avatar4.jpg') ?>" /> </div>
                                        <div class="mt-comment-body">
                                            <div class="mt-comment-info">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="mt-actions">
                                    <div class="mt-action">
                                        <div class="mt-action-img">
                                            <img src="<?php echo Theme::base('assets/pages/media/users/avatar10.jpg') ?>" /> </div>
                                    ...
                                    <div class="mt-action">
                                        <div class="mt-action-img">
                                            <img src="<?php echo Theme::base('assets/pages/media/users/avatar3.jpg') ?>" /> </div>
                                        <div class="mt-action-body">
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    <div class="mt-action-icon ">
                                    ...
                                    <div class="mt-action">
                                        <div class="mt-action-img">
                                            <img src="<?php echo Theme::base('assets/pages/media/users/avatar2.jpg') ?>" /> </div>
                                        <div class="mt-action-body">
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    <div class="mt-action-icon ">
                            ...
                            <div class="tab-pane" id="tab_actions_completed">
                                ...
                                <div class="mt-actions">
                                    ...
                                    <div class="mt-action">
                                        <div class="mt-action-img">
                                            <img src="<?php echo Theme::base('assets/pages/media/users/avatar5.jpg') ?>" /> </div>
                                        <div class="mt-action-body">
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    <div class="mt-action-icon ">
