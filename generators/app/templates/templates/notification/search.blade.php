...
@section('customcss')
<link href="<?php echo Theme::base('assets/apps/css/inbox.min.css') ?>" rel="stylesheet" type="text/css" />
@stop
...
<div class="inbox">
    <div class="row">
        <div class="col-md-12">
            ...
            @section('customjs')
            <script src="<?php echo Theme::base('assets/apps/scripts/inbox.min.js') ?>" type="text/javascript"></script>
            @stop
